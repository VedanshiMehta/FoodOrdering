    ...
    if (paymentMethod === "card" || paymentMethod === "wallet") {
      ...
      try {
        ...
        const response = await fetch("https://api.stripe.com/v1/payment_intents", {
          method: "POST",
          headers: {
            Authorization: "Bearer sk_test_51TbvAwBKPaQBNlXoqbLGGftRmuZbnIQM4SFMCaapzoAulEk0dqcLVyK1cM9hGVYeOzA82UPgEtOJcemOJog1VILz00PXKGjITL",
        ...
        Alert.alert("Secure Transaction Failed", err.message || "An unexpected error occurred.");
        dispatch(resetPayment());
      }
    } else {
      // Cash on Delivery
      ...
      >
        ...
        <ScrollView className="flex-1 px-5" showsVerticalScrollIndicator={false}>
          ...
          <View className="bg-orange-50 rounded-2xl p-4 mt-5 mb-6 flex-row items-center justify-between border border-orange-100">
            <View className="flex-1 mr-3">
              <Text className="text-orange-500 text-xs font-bold uppercase tracking-wider mb-1" style={{ fontFamily: "Quicksand-Bold" }}>
                Delivery Address
              </Text>
              <Text className="text-gray-800 text-sm font-semibold" numberOfLines={2} style={{ fontFamily: "Quicksand-Medium" }}>
                {orderAddress}
              </Text>
            </View>
          ...
          <Text className="text-base font-bold text-gray-800 mb-3" style={{ fontFamily: "Quicksand-Bold" }}>
            Select Payment Method
          </Text>
          <View className="flex-row bg-gray-100 p-1.5 rounded-2xl mb-6">
            <TouchableOpacity
              className={paymentMethod === "card" ? "flex-1 py-3 rounded-xl flex-row items-center justify-center gap-1.5 bg-white" : "flex-1 py-3 rounded-xl flex-row items-center justify-center gap-1.5"}
              style={paymentMethod === "card" ? styles.shadowSm : undefined}
              onPress={() => setPaymentMethod("card")}
            >
              <Ionicons name="card" size={18} color={paymentMethod === "card" ? "#f97316" : "#6b7280"} />
              <Text
                className={paymentMethod === "card" ? "text-xs font-bold text-gray-800" : "text-xs font-bold text-gray-500"}
            ...
            <TouchableOpacity
              className={paymentMethod === "wallet" ? "flex-1 py-3 rounded-xl flex-row items-center justify-center gap-1.5 bg-white" : "flex-1 py-3 rounded-xl flex-row items-center justify-center gap-1.5"}
              style={paymentMethod === "wallet" ? styles.shadowSm : undefined}
              onPress={() => setPaymentMethod("wallet")}
            >
              <Ionicons name="logo-google" size={18} color={paymentMethod === "wallet" ? "#f97316" : "#6b7280"} />
              <Text
                className={paymentMethod === "wallet" ? "text-xs font-bold text-gray-800" : "text-xs font-bold text-gray-500"}
                style={{ fontFamily: "Quicksand-Bold" }}
              >
                Apple/G-Pay
              </Text>
            ...
            <TouchableOpacity
              className={paymentMethod === "cod" ? "flex-1 py-3 rounded-xl flex-row items-center justify-center gap-1.5 bg-white" : "flex-1 py-3 rounded-xl flex-row items-center justify-center gap-1.5"}
              style={paymentMethod === "cod" ? styles.shadowSm : undefined}
              onPress={() => setPaymentMethod("cod")}
            >
              <Ionicons name="cash" size={18} color={paymentMethod === "cod" ? "#f97316" : "#6b7280"} />
              <Text
                className={paymentMethod === "cod" ? "text-xs font-bold text-gray-800" : "text-xs font-bold text-gray-500"}
                style={{ fontFamily: "Quicksand-Bold" }}
              >
                COD
              </Text>
              ...
              >
                ...
                <View className="flex-row justify-between items-center mb-6">
                  <View className="flex-row items-center gap-2">
                    ...
                    <Text className="text-white text-xs font-bold uppercase tracking-wider" style={{ fontFamily: "Quicksand-Bold" }}>
                      Stripe Platinum
                    </Text>
                  </View>
                ...
                >
                  <View className="absolute left-1.5 top-0 bottom-0 w-0.5" style={styles.bgAmber600_30} />
                  <View className="absolute left-3.5 top-0 bottom-0 w-0.5" style={styles.bgAmber600_30} />
                  <View className="absolute left-5.5 top-0 bottom-0 w-0.5" style={styles.bgAmber600_30} />
                  <View className="absolute top-1.5 left-0 right-0 h-0.5" style={styles.bgAmber600_30} />
                  <View className="absolute top-3.5 left-0 right-0 h-0.5" style={styles.bgAmber600_30} />
                  <View className="absolute top-5.5 left-0 right-0 h-0.5" style={styles.bgAmber600_30} />
                </View>
                ...
                <View className="flex-row justify-between items-end mt-auto">
                  <View className="flex-1 mr-4">
                    <Text className="text-neutral-500 text-[9px] uppercase font-bold tracking-wider mb-1" style={{ fontFamily: "Quicksand-Bold" }}>
                      Cardholder
                    </Text>
                    <Text className="text-white text-sm font-bold uppercase" numberOfLines={1} style={{ fontFamily: "Quicksand-Bold" }}>
              ...
              <View className="bg-gray-50 border border-gray-100 rounded-2xl p-5">
                <View className="flex-row items-start gap-3">
                  ...
                  <View className="flex-1">
                    <Text className="text-sm font-bold text-gray-800 mb-1" style={{ fontFamily: "Quicksand-Bold" }}>
                      Secure Checkout via Stripe
                    </Text>
                    <Text className="text-xs text-gray-500 leading-relaxed" style={{ fontFamily: "Quicksand-Medium" }}>
          ...
          {paymentMethod === "wallet" && (
            <View className="mb-6 bg-gray-50 border border-gray-100 rounded-2xl p-6 items-center justify-center py-10">
              ...
              <Text className="text-base font-bold text-gray-800 text-center mb-1" style={{ fontFamily: "Quicksand-Bold" }}>
                Google Pay / Apple Pay Express
              </Text>
              <Text className="text-xs text-gray-500 text-center px-6 mb-6" style={{ fontFamily: "Quicksand-Medium" }}>
              ...
              >
                ...
                <Text className="text-white text-base font-bold" style={{ fontFamily: "Quicksand-Bold" }}>Pay with Express Wallet</Text>
              </TouchableOpacity>
            </View>
          )}
          ...
          <View className="border-t border-gray-100 pt-5 mb-8">
            ...
            <View className="bg-gray-50 rounded-2xl p-4 border border-gray-100 gap-3">
              <View className="flex-row justify-between">
                <Text className="text-gray-500 text-sm font-semibold" style={{ fontFamily: "Quicksand-Medium" }}>Subtotal</Text>
                <Text className="text-gray-800 text-sm font-bold" style={{ fontFamily: "Quicksand-Bold" }}>${(orderTotal - 5 + 0.5).toFixed(2)}</Text>
              </View>
              <View className="flex-row justify-between">
                <Text className="text-gray-500 text-sm font-semibold" style={{ fontFamily: "Quicksand-Medium" }}>Delivery Fee</Text>
                <Text className="text-gray-800 text-sm font-bold" style={{ fontFamily: "Quicksand-Bold" }}>$5.00</Text>
              </View>
              <View className="flex-row justify-between">
                <Text className="text-gray-500 text-sm font-semibold" style={{ fontFamily: "Quicksand-Medium" }}>Discounts</Text>
                <Text className="text-success text-sm font-bold" style={{ fontFamily: "Quicksand-Bold" }}>-$0.50</Text>
              </View>
              <View className="border-b border-gray-150 my-1" />
              <View className="flex-row justify-between items-center">
                <Text className="text-gray-800 text-base font-bold" style={{ fontFamily: "Quicksand-Bold" }}>Total Amount</Text>
                <Text className="text-orange-500 text-lg font-bold" style={{ fontFamily: "Quicksand-Bold" }}>${orderTotal.toFixed(2)}</Text>
              </View>
            </View>
          </View>
        </ScrollView>
        ...
        <View className="px-5 py-4 border-t border-gray-100 bg-white">
          ...
          >
            ...
            <Text className="text-white text-lg font-bold" style={{ fontFamily: "Quicksand-Bold" }}>
      ...
      {paymentStatus === "processing" && (
        ...
        >
          ...
          >
            ...
            <Text className="text-lg font-bold text-gray-800 text-center mb-2" style={{ fontFamily: "Quicksand-Bold" }}>
              Secure Payment
            </Text>
            <Text className="text-xs text-gray-500 text-center leading-relaxed" style={{ fontFamily: "Quicksand-Medium" }}>
              Processing transaction via Stripe secure gateway. Please do not close the app...
            </Text>
          </View>
        </View>
      )}
      ...
      {showAlert && (
        ...
        >
          ...
          >
            ...
            <Text className="text-xs text-gray-500 text-center leading-relaxed" style={{ fontFamily: "Quicksand-Medium" }}>
              Your payment was processed successfully. Redirecting you to track your delivery...
            </Text>
          </Animated.View>
        </Animated.View>
      )}
